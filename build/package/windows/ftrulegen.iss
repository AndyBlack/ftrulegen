...
AppVersion=1.4.2
AppVerName=FLExTransRuleAssistant version 1.4.2
...
;WinXP or above
MinVersion=0,5.1
OutputBaseFilename=FLExTransRuleAssistant-1.4.2
Compression=lzma
...
UninstallDisplayName=FLExTransRuleAssistant version 1.4.2
