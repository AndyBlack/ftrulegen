...
AppVersion=1.3.0
AppVerName=FLExTransRuleAssistant version 1.3.0
...
;WinXP or above
MinVersion=0,5.1
OutputBaseFilename=FLExTransRuleAssistant-1.3.0
Compression=lzma
...
UninstallDisplayName=FLExTransRuleAssistant version 1.3.0
