...
AppVersion=1.0.1
AppVerName=FLExTransRuleAssistant version 1.0.1
...
;WinXP or above
MinVersion=0,5.1
OutputBaseFilename=FLExTransRuleAssistant-1.0.1
Compression=lzma
...
UninstallDisplayName=FLExTransRuleAssistant version 1.0.1
