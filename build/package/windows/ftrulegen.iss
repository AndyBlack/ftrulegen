...
AppVersion=1.5.0
AppVerName=FLExTransRuleAssistant version 1.5.0
...
;WinXP or above
MinVersion=0,5.1
OutputBaseFilename=FLExTransRuleAssistant-1.5.0
Compression=lzma
...
UninstallDisplayName=FLExTransRuleAssistant version 1.5.0
